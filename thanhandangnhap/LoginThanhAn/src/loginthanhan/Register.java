...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tfPassword1 = new javax.swing.JLabel();
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/hihih.png"))); // NOI18N
        ...
        tfPassword1.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tfPassword1.setText("Re_type Password :");
    ...
    if(jTextField1.getText().equals("")){
        JOptionPane.showMessageDialog(this, " Full Name should not be empty !", " Error", JOptionPane.ERROR_MESSAGE);
    }else{
    }
  ...
  //      tfPassword.requestFocus();
    ...
    if(!password.equals(confirm)){
        //sb.append("The entered passwords do not match ! Try again.")
        JOptionPane.showMessageDialog(this, " The entered passwords do not match ! Try again.", " Error", JOptionPane.ERROR_MESSAGE);
    }else {
    }
    ...
    private javax.swing.JLabel tfPassword1;
